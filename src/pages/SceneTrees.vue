<template>
    <b-container class="mt-4">
        ...
        <b-row class="mt-4">
            <p>
                There are applications of antialiasing using algorithms on the figures but also using artificial intelligences to predict the points that would help to improve the sampling of the signals.
            </p>
        </b-row>
        <b-row>
            <p>
                In the article "Evaluating Different Spatial Anti Aliasing Techniques" by Victor Kesten, different methods for the implementation of antialising are shown, but it is mentioned that the MSAAx4 and FXAA methods are the most optimal for antialising in 3D contexts on computers with not very good computational capabilities.
            </p>
        </b-row>
        <b-row align-content="center" align-h="center" align-v="center">
            <b-col>
        ...
        <b-row>
            <p>
                We are going to present an implementation of antialising using sampling and barycentric coordinates to draw a triangle, here the step by step is as follows
            </p>
            <p>
                <ul>
                    <li>
        ...
        <b-row>
            ...
            <p>
                <ul>
                    <li>
                        The barycentric coordinates are very useful in this method of antialising, where we smooth the loss of information in triangles.
                    </li>
                    <li>
                        Antialising will not be very useful when we want to represent figures in high resolution media since the loss of information will be very low.
                    </li>
                    <li>
                        The use of this technique in some cases will greatly improve the user experience.
                    </li>
                    <li>
                        Antialising is a process that should be used with care as it is adding load to the graphics processing.
                    </li>
                </ul>
            </p>
        </b-row>
